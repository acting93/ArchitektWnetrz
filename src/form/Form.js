...
class Form extends Component {
   ...
   //obsluga inputów
    ...
    //sprawdzenie walidacji + wysłanie formularza
    handleSubmit=(e)=>{
        e.preventDefault();
    ...
    validation=()=>{
        ...
        if(regexNumber.test(this.state.phone)){
            phone = true
        }
                ...
                <form onSubmit={this.handleSubmit} method="post" noValidate>
                    ...
                    <label htmlFor="mail">Adres e-mail:</label><br/>
                         <input
                          ...
                          onChange={this.handleChange}
                          /><br/>
                         {this.state.errors.mail ? <p className="error">Niepoprawny adres</p> : null}
                    ...
                    <label htmlFor="phone">Telefon:</label><br/>
                         <input
                          ...
                          onChange={this.handleChange}
                          /><br/>
                         {this.state.errors.phone ? <p className="error">Proszę wprowadzić cyfry</p> : null}
