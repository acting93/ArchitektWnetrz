...
class Range extends Component {
    ...
    //zarządzenie wartościami z inputów
    handleValue=(e)=>{
    ...
    //obsługa inputów range +  obliczenia
    handlePrize(){
    //pakiety
    ...
    componentWillUnmount(){
     ...
     render() {
       // const progressSlideRange = (this.state.m2Flat/90)*100 /// kolor inutów przy przesuwaniu
        ...
        return (
            <>
               <div className="prizeContainer col-12">
                    <div className="pakietChoose col-12 col-xl-10">
                    <p>Wybierz pakiet i sprawdź cenę</p>
                        <ul>
                            <li style={this.state.activeMini ? {borderBottom:"3px solid #646464"}:null} id="mini" onClick={this.handlePakiet}>Mini</li>
                            <li style={this.state.activeComfort ? {borderBottom:"3px solid #646464"}:null} id="comfort" onClick={this.handlePakiet}>Comfort</li>
                            <li style={this.state.activeMaxi ? {borderBottom:"3px solid #646464"}:null} id="maxi" onClick={this.handlePakiet}>Maxi</li>
                            <NavLink to='/contact'><li style={this.state.activePlus ? {borderBottom:"3px solid #646464"}:null} id="plus" onClick={this.handlePakiet}>Plus</li></NavLink>
                        </ul>
                    </div>
                    <div className="inputsRange">
                        <div className="inputsDiv">
                            <div className="input">
                                    <span><p>Powierzchnia mieszkania w m<sup>2</sup></p></span>
                        ...
                        <div className="total">
                            <p style={{color:'white',textShadow:"0px 0px 1px silver"}}>Podsumowanie:</p>
                            <p style={{color:'white'}}>{this.state.total} PLN</p>
                            <p style={{color:"white"}}>Cena dotyczy pakietu: {this.state.pakietName} </p>
                        </div> 
                    </div>
